...
Statements is a natural language todo list you wish you had. A modern, minimalist application built with Next.js that leverages AI to understand voice commands and natural language input.
...
Copyright (c) 2025 Yeswanth Madasu
